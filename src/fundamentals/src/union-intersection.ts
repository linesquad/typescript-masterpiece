...
function flipCoin(): 'heads' | 'tails' {
  if (Math.random() > 0.5) return 'heads' as const
...
let evenOrLowNumbers: Evens | OneThroughFive;
evenOrLowNumbers = 6 //✔️ An even
evenOrLowNumbers = 3 //✔️ A low number
evenOrLowNumbers = 4 //✔️ A even low number
...
evenAndLowNumber = 2 //✔️ In both sets
